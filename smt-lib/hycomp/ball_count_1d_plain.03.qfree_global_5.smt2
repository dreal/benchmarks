...
(assert (let ((.def_907 (* 49.0 b.delta__AT5)))
(let ((.def_908 (* b.delta__AT5 .def_907)))
(let ((.def_909 (* (- 1.0) .def_908)))
(let ((.def_905 (* 10.0 b.delta__AT5)))
(let ((.def_906 (* b.speed_y__AT5 .def_905)))
(let ((.def_910 (+ .def_906 .def_909)))
(let ((.def_911 (* 10.0 b.y__AT5)))
(let ((.def_913 (+ .def_911 .def_910)))
(let ((.def_914 (<= 0.0 .def_913)))
(let ((.def_889 (<= 0.0 b.y__AT5)))
(let ((.def_915 (and .def_889 .def_914)))
(let ((.def_903 (<= 0.0 b.delta__AT5)))
(let ((.def_904 (not .def_903)))
(let ((.def_916 (or .def_904 .def_915)))
(let ((.def_886 (not b.EVENT.0__AT5)))
(let ((.def_884 (not b.EVENT.1__AT5)))
(let ((.def_900 (and .def_884 .def_886)))
(let ((.def_901 (not .def_900)))
(let ((.def_917 (or .def_901 .def_916)))
(let ((.def_615 (not b.counter.0__AT4)))
(let ((.def_603 (not b.counter.1__AT4)))
(let ((.def_893 (and .def_603 .def_615)))
(let ((.def_896 (or b.counter.3__AT4 .def_893)))
(let ((.def_610 (not b.counter.2__AT4)))
(let ((.def_894 (and .def_610 .def_893)))
(let ((.def_625 (not b.counter.3__AT4)))
(let ((.def_895 (or .def_625 .def_894)))
...
(let ((.def_877 (or .def_4 .def_6)))
(let ((.def_881 (or b.counter.3__AT5 .def_877)))
(let ((.def_878 (or b.counter.2__AT5 .def_877)))
(let ((.def_9 (not b.counter.2__AT5)))
(let ((.def_876 (or .def_6 .def_9)))
(let ((.def_879 (and .def_876 .def_878)))
(let ((.def_12 (not b.counter.3__AT5)))
(let ((.def_880 (or .def_12 .def_879)))
...
(let ((.def_872 (or .def_742 .def_744)))
...
(let ((.def_869 (or .def_742 .def_807)))
(let ((.def_870 (or b.EVENT.1__AT4 .def_869)))
(let ((.def_857 (* (- 5.0) b.speed_y__AT5)))
(let ((.def_858 (* (- 49.0) b.delta__AT4)))
(let ((.def_862 (+ .def_858 .def_857)))
(let ((.def_860 (* 5.0 b.speed_y__AT4)))
(let ((.def_863 (+ .def_860 .def_862)))
...
(let ((.def_854 (+ .def_851 .def_850)))
(let ((.def_752 (* 10.0 b.y__AT4)))
(let ((.def_855 (+ .def_752 .def_854)))
(let ((.def_856 (= .def_855 0.0 )))
(let ((.def_865 (and .def_856 .def_864)))
(let ((.def_866 (or .def_742 .def_865)))
(let ((.def_812 (= b.y__AT4 b.y__AT5)))
(let ((.def_800 (= b.speed_y__AT4 b.speed_y__AT5)))
(let ((.def_843 (and .def_800 .def_812)))
(let ((.def_840 (= b.delta__AT4 0.0 )))
(let ((.def_841 (and .def_741 .def_840)))
...
(let ((.def_822 (= b.time__AT4 b.time__AT5)))
(let ((.def_834 (and .def_812 .def_822)))
(let ((.def_835 (and .def_800 .def_834)))
(let ((.def_836 (and .def_807 .def_835)))
(let ((.def_837 (or .def_725 .def_836)))
(let ((.def_825 (* (- 1.0) b.time__AT5)))
(let ((.def_828 (+ b.delta__AT4 .def_825)))
(let ((.def_829 (+ b.time__AT4 .def_828)))
(let ((.def_830 (= .def_829 0.0 )))
(let ((.def_831 (or .def_742 .def_830)))
(let ((.def_832 (or b.EVENT.1__AT4 .def_831)))
(let ((.def_823 (or .def_741 .def_822)))
(let ((.def_824 (or b.EVENT.1__AT4 .def_823)))
(let ((.def_833 (and .def_824 .def_832)))
(let ((.def_838 (and .def_833 .def_837)))
(let ((.def_818 (= .def_742 b.event_is_timed__AT5)))
(let ((.def_816 (= b.event_is_timed__AT4 .def_741)))
...
(let ((.def_771 (or b.counter.1__AT5 b.counter.1__AT4)))
(let ((.def_769 (and .def_4 b.counter.0__AT5)))
(let ((.def_770 (or .def_603 .def_769)))
(let ((.def_772 (and .def_770 .def_771)))
(let ((.def_773 (and .def_9 .def_772)))
(let ((.def_774 (or .def_610 .def_773)))
(let ((.def_784 (and .def_774 .def_783)))
(let ((.def_785 (and .def_12 .def_784)))
(let ((.def_786 (or .def_625 .def_785)))
...
(let ((.def_899 (and .def_759 .def_898)))
(let ((.def_918 (and .def_899 .def_917)))
.def_918))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
