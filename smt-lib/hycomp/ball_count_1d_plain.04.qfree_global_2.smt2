...
(assert (let ((.def_413 (* 49.0 b.delta__AT2)))
(let ((.def_414 (* b.delta__AT2 .def_413)))
(let ((.def_415 (* (- 1.0) .def_414)))
(let ((.def_411 (* 10.0 b.delta__AT2)))
...
(let ((.def_409 (<= 0.0 b.delta__AT2)))
(let ((.def_410 (not .def_409)))
(let ((.def_422 (or .def_410 .def_421)))
(let ((.def_390 (not b.EVENT.0__AT2)))
(let ((.def_388 (not b.EVENT.1__AT2)))
(let ((.def_406 (and .def_388 .def_390)))
(let ((.def_407 (not .def_406)))
(let ((.def_423 (or .def_407 .def_422)))
(let ((.def_114 (not b.counter.0__AT1)))
(let ((.def_102 (not b.counter.1__AT1)))
(let ((.def_398 (and .def_102 .def_114)))
(let ((.def_402 (or b.counter.3__AT1 .def_398)))
(let ((.def_399 (or b.counter.2__AT1 .def_398)))
(let ((.def_109 (not b.counter.2__AT1)))
(let ((.def_397 (or .def_102 .def_109)))
(let ((.def_400 (and .def_397 .def_399)))
(let ((.def_124 (not b.counter.3__AT1)))
(let ((.def_401 (or .def_124 .def_400)))
...
(let ((.def_376 (or .def_246 .def_248)))
...
(let ((.def_373 (or .def_246 .def_311)))
(let ((.def_374 (or b.EVENT.1__AT1 .def_373)))
(let ((.def_361 (* (- 5.0) b.speed_y__AT2)))
(let ((.def_362 (* (- 49.0) b.delta__AT1)))
(let ((.def_366 (+ .def_362 .def_361)))
(let ((.def_364 (* 5.0 b.speed_y__AT1)))
(let ((.def_367 (+ .def_364 .def_366)))
...
(let ((.def_351 (* (- 49.0) .def_350)))
(let ((.def_354 (+ .def_351 .def_353)))
(let ((.def_355 (* (- 10.0) b.y__AT2)))
(let ((.def_358 (+ .def_355 .def_354)))
(let ((.def_256 (* 10.0 b.y__AT1)))
(let ((.def_359 (+ .def_256 .def_358)))
(let ((.def_360 (= .def_359 0.0 )))
(let ((.def_369 (and .def_360 .def_368)))
(let ((.def_370 (or .def_246 .def_369)))
(let ((.def_316 (= b.y__AT1 b.y__AT2)))
(let ((.def_304 (= b.speed_y__AT1 b.speed_y__AT2)))
(let ((.def_347 (and .def_304 .def_316)))
(let ((.def_344 (= b.delta__AT1 0.0 )))
(let ((.def_345 (and .def_245 .def_344)))
...
(let ((.def_322 (= .def_246 b.event_is_timed__AT2)))
(let ((.def_320 (= b.event_is_timed__AT1 .def_245)))
...
(let ((.def_281 (or .def_9 b.counter.0__AT1)))
(let ((.def_280 (or b.counter.0__AT2 .def_114)))
(let ((.def_282 (and .def_280 .def_281)))
(let ((.def_283 (and .def_6 .def_282)))
(let ((.def_284 (or b.counter.1__AT1 .def_283)))
(let ((.def_279 (or b.counter.1__AT2 .def_102)))
(let ((.def_285 (and .def_279 .def_284)))
(let ((.def_296 (and .def_4 .def_285)))
(let ((.def_297 (or b.counter.2__AT1 .def_296)))
(let ((.def_291 (and .def_6 .def_114)))
...
(let ((.def_273 (and .def_6 b.counter.0__AT2)))
(let ((.def_274 (or .def_102 .def_273)))
(let ((.def_276 (and .def_274 .def_275)))
(let ((.def_277 (and .def_4 .def_276)))
(let ((.def_278 (or .def_109 .def_277)))
(let ((.def_288 (and .def_278 .def_287)))
(let ((.def_289 (and .def_14 .def_288)))
...
(let ((.def_318 (or .def_245 .def_317)))
(let ((.def_319 (or b.EVENT.1__AT1 .def_318)))
...
(let ((.def_379 (and .def_228 .def_378)))
