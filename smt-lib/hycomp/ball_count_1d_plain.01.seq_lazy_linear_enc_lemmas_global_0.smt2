...
;; generated on Mon Mar 19 10:45:40 2012
...
(assert (let ((.def_74 (<= 0.0 b.speed_y__AT0)))
(let ((.def_67 (* (- 49.0) b.delta__AT0)))
(let ((.def_69 (* 5.0 b.speed_y__AT0)))
(let ((.def_71 (+ .def_69 .def_67)))
(let ((.def_72 (<= 0.0 .def_71)))
(let ((.def_73 (not .def_72)))
(let ((.def_105 (or .def_73 .def_74)))
(let ((.def_88 (<= .def_71 0.0 )))
(let ((.def_86 (<= b.speed_y__AT0 0.0 )))
(let ((.def_87 (not .def_86)))
(let ((.def_104 (or .def_87 .def_88)))
(let ((.def_106 (and .def_104 .def_105)))
(let ((.def_101 (and .def_86 .def_88)))
(let ((.def_100 (and .def_72 .def_74)))
