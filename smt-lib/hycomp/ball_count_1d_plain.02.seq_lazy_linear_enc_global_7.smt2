...
(assert (let ((.def_1228 (* (- 49.0) b.delta__AT7)))
(let ((.def_1229 (* 5.0 b.speed_y__AT7)))
(let ((.def_1231 (+ .def_1229 .def_1228)))
(let ((.def_1235 (<= .def_1231 0.0 )))
(let ((.def_1234 (<= b.speed_y__AT7 0.0 )))
(let ((.def_1236 (and .def_1234 .def_1235)))
(let ((.def_1232 (<= 0.0 .def_1231)))
(let ((.def_1227 (<= 0.0 b.speed_y__AT7)))
(let ((.def_1233 (and .def_1227 .def_1232)))
(let ((.def_1237 (or .def_1233 .def_1236)))
(let ((.def_1219 (* b.speed_y__AT7 b.delta__AT7)))
(let ((.def_1220 (* 10.0 .def_1219)))
(let ((.def_1217 (* b.delta__AT7 b.delta__AT7)))
(let ((.def_1218 (* (- 49.0) .def_1217)))
(let ((.def_1221 (+ .def_1218 .def_1220)))
(let ((.def_1222 (* 10.0 b.y__AT7)))
(let ((.def_1224 (+ .def_1222 .def_1221)))
(let ((.def_1225 (<= 0.0 .def_1224)))
...
(let ((.def_1107 (not b.counter.3__AT7)))
...
(let ((.def_1190 (<= 0.0 b.delta__AT6)))
(let ((.def_1046 (not b.EVENT.0__AT6)))
(let ((.def_1044 (not b.EVENT.1__AT6)))
(let ((.def_1137 (and .def_1044 .def_1046)))
(let ((.def_1141 (not .def_1137)))
(let ((.def_1191 (or .def_1141 .def_1190)))
(let ((.def_1192 (or b.EVENT.1__AT6 .def_1191)))
(let ((.def_1129 (= b.counter.0__AT7 b.counter.0__AT6)))
(let ((.def_1127 (= b.counter.1__AT7 b.counter.1__AT6)))
(let ((.def_1125 (= b.counter.2__AT7 b.counter.2__AT6)))
(let ((.def_1124 (= b.counter.3__AT6 b.counter.3__AT7)))
(let ((.def_1126 (and .def_1124 .def_1125)))
(let ((.def_1128 (and .def_1126 .def_1127)))
(let ((.def_1130 (and .def_1128 .def_1129)))
(let ((.def_1187 (or .def_1130 .def_1141)))
(let ((.def_1188 (or b.EVENT.1__AT6 .def_1187)))
(let ((.def_1175 (* (- 10.0) b.y__AT7)))
(let ((.def_1060 (* b.speed_y__AT6 b.delta__AT6)))
(let ((.def_1061 (* 10.0 .def_1060)))
(let ((.def_1179 (+ .def_1061 .def_1175)))
(let ((.def_1058 (* b.delta__AT6 b.delta__AT6)))
(let ((.def_1059 (* (- 49.0) .def_1058)))
(let ((.def_1180 (+ .def_1059 .def_1179)))
(let ((.def_1063 (* 10.0 b.y__AT6)))
(let ((.def_1181 (+ .def_1063 .def_1180)))
(let ((.def_1182 (= .def_1181 0.0 )))
(let ((.def_1171 (* (- 5.0) b.speed_y__AT7)))
(let ((.def_1069 (* (- 49.0) b.delta__AT6)))
(let ((.def_1172 (+ .def_1069 .def_1171)))
(let ((.def_1070 (* 5.0 b.speed_y__AT6)))
(let ((.def_1173 (+ .def_1070 .def_1172)))
(let ((.def_1174 (= .def_1173 0.0 )))
(let ((.def_1183 (and .def_1174 .def_1182)))
(let ((.def_1184 (or .def_1141 .def_1183)))
(let ((.def_1135 (= b.y__AT6 b.y__AT7)))
(let ((.def_1123 (= b.speed_y__AT6 b.speed_y__AT7)))
(let ((.def_1168 (and .def_1123 .def_1135)))
(let ((.def_1165 (= b.delta__AT6 0.0 )))
...
(let ((.def_1185 (and .def_1170 .def_1184)))
(let ((.def_1147 (= b.time__AT6 b.time__AT7)))
(let ((.def_1159 (and .def_1135 .def_1147)))
(let ((.def_1160 (and .def_1123 .def_1159)))
(let ((.def_1161 (and .def_1130 .def_1160)))
(let ((.def_1162 (or .def_1044 .def_1161)))
(let ((.def_1150 (* (- 1.0) b.time__AT7)))
(let ((.def_1153 (+ b.delta__AT6 .def_1150)))
(let ((.def_1154 (+ b.time__AT6 .def_1153)))
(let ((.def_1155 (= .def_1154 0.0 )))
(let ((.def_1156 (or .def_1141 .def_1155)))
(let ((.def_1157 (or b.EVENT.1__AT6 .def_1156)))
(let ((.def_1148 (or .def_1137 .def_1147)))
(let ((.def_1149 (or b.EVENT.1__AT6 .def_1148)))
(let ((.def_1158 (and .def_1149 .def_1157)))
(let ((.def_1163 (and .def_1158 .def_1162)))
(let ((.def_1143 (= .def_1141 b.event_is_timed__AT7)))
(let ((.def_1140 (= b.event_is_timed__AT6 .def_1137)))
...
(let ((.def_1132 (or .def_1084 .def_1131)))
(let ((.def_1098 (or .def_6 b.counter.0__AT6)))
(let ((.def_1097 (or b.counter.0__AT7 .def_938)))
(let ((.def_1099 (and .def_1097 .def_1098)))
(let ((.def_1100 (and .def_4 .def_1099)))
(let ((.def_1101 (or b.counter.1__AT6 .def_1100)))
(let ((.def_1096 (or b.counter.1__AT7 .def_926)))
(let ((.def_1102 (and .def_1096 .def_1101)))
(let ((.def_1115 (and .def_9 .def_1102)))
(let ((.def_1116 (or b.counter.2__AT6 .def_1115)))
(let ((.def_1110 (and .def_4 .def_938)))
(let ((.def_1111 (or b.counter.1__AT6 .def_1110)))
(let ((.def_1112 (and .def_1096 .def_1111)))
(let ((.def_1113 (and b.counter.2__AT7 .def_1112)))
(let ((.def_1114 (or .def_933 .def_1113)))
(let ((.def_1117 (and .def_1114 .def_1116)))
(let ((.def_1118 (and b.counter.3__AT7 .def_1117)))
(let ((.def_1119 (or b.counter.3__AT6 .def_1118)))
...
(let ((.def_1090 (and .def_4 b.counter.0__AT7)))
(let ((.def_1091 (or .def_926 .def_1090)))
(let ((.def_1093 (and .def_1091 .def_1092)))
(let ((.def_1094 (and .def_9 .def_1093)))
(let ((.def_1095 (or .def_933 .def_1094)))
...
(let ((.def_1194 (and .def_1044 .def_1193)))
...
(let ((.def_1215 (and .def_1081 .def_1214)))
(let ((.def_1240 (and .def_1215 .def_1239)))
.def_1240))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
