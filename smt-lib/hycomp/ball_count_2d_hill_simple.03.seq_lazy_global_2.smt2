...
(let ((.def_458 (* .def_92 b.delta__AT2)))
(let ((.def_459 (<= b.speed_y__AT2 .def_458)))
(let ((.def_457 (<= b.speed_y__AT2 0.0 )))
(let ((.def_460 (and .def_457 .def_459)))
(let ((.def_453 (* .def_86 b.delta__AT2)))
(let ((.def_454 (+ b.speed_y__AT2 .def_453)))
(let ((.def_455 (<= 0.0 .def_454)))
(let ((.def_452 (<= 0.0 b.speed_y__AT2)))
...
(let ((.def_445 (* (- 1.0) .def_428)))
(let ((.def_448 (+ .def_445 .def_444)))
...
(let ((.def_463 (and .def_63 .def_462)))
(let ((.def_168 (not b.counter.0__AT1)))
(let ((.def_158 (not b.counter.1__AT1)))
(let ((.def_433 (and .def_158 .def_168)))
(let ((.def_436 (or b.counter.3__AT1 .def_433)))
(let ((.def_163 (not b.counter.2__AT1)))
(let ((.def_434 (and .def_163 .def_433)))
(let ((.def_177 (not b.counter.3__AT1)))
(let ((.def_435 (or .def_177 .def_434)))
...
(let ((.def_319 (= b.counter.0__AT2 b.counter.0__AT1)))
(let ((.def_317 (= b.counter.1__AT2 b.counter.1__AT1)))
(let ((.def_315 (= b.counter.2__AT2 b.counter.2__AT1)))
(let ((.def_314 (= b.counter.3__AT2 b.counter.3__AT1)))
(let ((.def_316 (and .def_314 .def_315)))
(let ((.def_318 (and .def_316 .def_317)))
(let ((.def_320 (and .def_318 .def_319)))
(let ((.def_405 (and .def_320 .def_323)))
(let ((.def_406 (or .def_288 .def_405)))
(let ((.def_407 (or b.EVENT.1__AT1 .def_406)))
(let ((.def_394 (* .def_70 b.delta__AT1)))
...
(let ((.def_402 (or .def_288 .def_401)))
(let ((.def_309 (= b.y__AT1 b.y__AT2)))
(let ((.def_380 (and .def_306 .def_309)))
(let ((.def_312 (= b.speed_y__AT1 b.speed_y__AT2)))
(let ((.def_381 (and .def_312 .def_380)))
...
(let ((.def_373 (and .def_306 .def_372)))
(let ((.def_374 (and .def_309 .def_373)))
(let ((.def_375 (or .def_286 .def_374)))
...
(let ((.def_325 (or .def_245 .def_324)))
...
(let ((.def_439 (and .def_285 .def_438)))
(let ((.def_464 (and .def_439 .def_463)))
.def_464)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
