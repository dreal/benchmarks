...
(let ((.def_165 (and .def_58 .def_164)))
...
(let ((.def_166 (and .def_62 .def_165)))
.def_166)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
