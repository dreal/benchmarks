...
(assert (let ((.def_956 (* b.x__AT4 b.x__AT4)))
(let ((.def_952 (* 5.0 b.delta__AT4)))
(let ((.def_953 (* b.delta__AT4 .def_952)))
(let ((.def_954 (* (- 1.0) .def_953)))
(let ((.def_959 (+ .def_954 .def_956)))
(let ((.def_951 (* b.speed_y__AT4 b.delta__AT4)))
(let ((.def_960 (+ .def_951 .def_959)))
(let ((.def_961 (+ b.y__AT4 .def_960)))
(let ((.def_962 (<= 0.0 .def_961)))
(let ((.def_992 (not .def_962)))
(let ((.def_974 (* (- 10.0) b.delta__AT4)))
(let ((.def_975 (+ b.speed_y__AT4 .def_974)))
(let ((.def_976 (<= 0.0 .def_975)))
(let ((.def_993 (and .def_976 .def_992)))
(let ((.def_985 (+ b.y__AT4 .def_956)))
(let ((.def_990 (<= 0.0 .def_985)))
(let ((.def_987 (<= b.speed_y__AT4 0.0 )))
(let ((.def_991 (or .def_987 .def_990)))
(let ((.def_994 (or .def_991 .def_993)))
(let ((.def_986 (<= .def_985 0.0 )))
(let ((.def_988 (and .def_986 .def_987)))
(let ((.def_980 (<= .def_975 0.0 )))
(let ((.def_981 (not .def_980)))
(let ((.def_978 (= .def_961 0.0 )))
(let ((.def_979 (not .def_978)))
(let ((.def_982 (or .def_979 .def_981)))
(let ((.def_977 (or .def_962 .def_976)))
(let ((.def_983 (and .def_977 .def_982)))
(let ((.def_964 (* 20.0 b.x__AT4)))
(let ((.def_965 (* b.x__AT4 .def_964)))
(let ((.def_838 (* b.speed_y__AT4 b.speed_y__AT4)))
(let ((.def_966 (+ .def_838 .def_965)))
(let ((.def_967 (* 20.0 b.y__AT4)))
(let ((.def_969 (+ .def_967 .def_966)))
(let ((.def_972 (<= .def_969 0.0 )))
...
(let ((.def_914 (or .def_737 .def_739)))
(let ((.def_915 (or b.EVENT.1__AT3 .def_914)))
(let ((.def_825 (= b.bool_atom__AT3 b.bool_atom__AT4)))
(let ((.def_821 (= b.counter.0__AT4 b.counter.0__AT3)))
(let ((.def_819 (= b.counter.1__AT4 b.counter.1__AT3)))
(let ((.def_817 (= b.counter.2__AT4 b.counter.2__AT3)))
(let ((.def_816 (= b.counter.3__AT4 b.counter.3__AT3)))
(let ((.def_818 (and .def_816 .def_817)))
(let ((.def_820 (and .def_818 .def_819)))
(let ((.def_822 (and .def_820 .def_821)))
(let ((.def_910 (and .def_822 .def_825)))
(let ((.def_911 (or .def_737 .def_910)))
(let ((.def_912 (or b.EVENT.1__AT3 .def_911)))
(let ((.def_239 (* (- 1.0) b.g__AT0)))
(let ((.def_898 (* .def_239 b.delta__AT3)))
(let ((.def_899 (* (- 1.0) b.speed_y__AT4)))
(let ((.def_902 (+ .def_899 .def_898)))
(let ((.def_903 (+ b.speed_y__AT3 .def_902)))
(let ((.def_904 (= .def_903 0.0 )))
(let ((.def_888 (* b.delta__AT3 b.delta__AT3)))
(let ((.def_242 (* (/ 1 2) .def_239)))
(let ((.def_889 (* .def_242 .def_888)))
(let ((.def_890 (* (- 1.0) b.y__AT4)))
(let ((.def_894 (+ .def_890 .def_889)))
(let ((.def_741 (* b.speed_y__AT3 b.delta__AT3)))
(let ((.def_895 (+ .def_741 .def_894)))
(let ((.def_896 (+ b.y__AT3 .def_895)))
(let ((.def_897 (= .def_896 0.0 )))
(let ((.def_905 (and .def_897 .def_904)))
(let ((.def_808 (= b.x__AT3 b.x__AT4)))
(let ((.def_906 (and .def_808 .def_905)))
(let ((.def_907 (or .def_737 .def_906)))
(let ((.def_811 (= b.y__AT3 b.y__AT4)))
(let ((.def_883 (and .def_808 .def_811)))
(let ((.def_814 (= b.speed_y__AT3 b.speed_y__AT4)))
(let ((.def_884 (and .def_814 .def_883)))
(let ((.def_880 (= b.delta__AT3 0.0 )))
(let ((.def_881 (and .def_736 .def_880)))
(let ((.def_882 (not .def_881)))
(let ((.def_885 (or .def_882 .def_884)))
(let ((.def_886 (or b.EVENT.1__AT3 .def_885)))
(let ((.def_873 (and .def_814 .def_822)))
(let ((.def_874 (or b.bool_atom__AT3 .def_873)))
(let ((.def_849 (or .def_9 b.counter.0__AT3)))
(let ((.def_848 (or b.counter.0__AT4 .def_637)))
(let ((.def_850 (and .def_848 .def_849)))
(let ((.def_851 (and .def_6 .def_850)))
(let ((.def_852 (or b.counter.1__AT3 .def_851)))
(let ((.def_847 (or b.counter.1__AT4 .def_627)))
(let ((.def_853 (and .def_847 .def_852)))
(let ((.def_864 (and .def_4 .def_853)))
(let ((.def_865 (or b.counter.2__AT3 .def_864)))
(let ((.def_859 (and .def_6 .def_637)))
(let ((.def_860 (or b.counter.1__AT3 .def_859)))
(let ((.def_861 (and .def_847 .def_860)))
(let ((.def_862 (and b.counter.2__AT4 .def_861)))
(let ((.def_863 (or .def_632 .def_862)))
...
(let ((.def_841 (and .def_6 b.counter.0__AT4)))
(let ((.def_842 (or .def_627 .def_841)))
(let ((.def_844 (and .def_842 .def_843)))
(let ((.def_845 (and .def_4 .def_844)))
(let ((.def_846 (or .def_632 .def_845)))
(let ((.def_856 (and .def_846 .def_855)))
(let ((.def_857 (and .def_14 .def_856)))
(let ((.def_858 (or .def_646 .def_857)))
(let ((.def_869 (and .def_858 .def_868)))
(let ((.def_624 (* b.speed_y__AT3 b.speed_y__AT3)))
(let ((.def_839 (= .def_624 .def_838)))
...
(let ((.def_876 (and .def_808 .def_875)))
(let ((.def_877 (and .def_811 .def_876)))
(let ((.def_878 (or .def_736 .def_877)))
...
(let ((.def_827 (or .def_716 .def_826)))
...
(let ((.def_829 (and .def_793 .def_828)))
(let ((.def_909 (and .def_829 .def_908)))
(let ((.def_913 (and .def_909 .def_912)))
(let ((.def_916 (and .def_913 .def_915)))
(let ((.def_917 (and .def_716 .def_916)))
(let ((.def_936 (and .def_917 .def_935)))
...
(let ((.def_945 (and .def_789 .def_944)))
(let ((.def_999 (and .def_945 .def_998)))
.def_999))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
