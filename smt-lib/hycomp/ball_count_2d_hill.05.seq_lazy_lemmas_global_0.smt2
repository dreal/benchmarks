...
(let ((.def_193 (or .def_131 .def_192)))
(let ((.def_183 (<= .def_182 0.0 )))
(let ((.def_145 (<= .def_130 0.0 )))
(let ((.def_146 (not .def_145)))
(let ((.def_191 (or .def_146 .def_183)))
(let ((.def_194 (and .def_191 .def_193)))
(let ((.def_163 (<= .def_78 (- (/ 49 10)))))
(let ((.def_195 (or .def_163 .def_194)))
(let ((.def_187 (not .def_183)))
(let ((.def_188 (or .def_145 .def_187)))
...
(let ((.def_143 (<= .def_126 0.0 )))
(let ((.def_144 (not .def_143)))
(let ((.def_166 (or .def_144 .def_145)))
(let ((.def_127 (<= 0.0 .def_126)))
(let ((.def_165 (or .def_127 .def_132)))
(let ((.def_167 (and .def_165 .def_166)))
(let ((.def_169 (or .def_167 .def_168)))
(let ((.def_128 (not .def_127)))
(let ((.def_159 (or .def_128 .def_131)))
(let ((.def_158 (or .def_143 .def_146)))
...
(let ((.def_198 (or .def_171 .def_197)))
...
(let ((.def_200 (and .def_68 .def_199)))
...
(let ((.def_201 (and .def_72 .def_200)))
.def_201))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
