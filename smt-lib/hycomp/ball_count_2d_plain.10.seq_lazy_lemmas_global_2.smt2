...
(let ((.def_579 (* .def_124 b.delta__AT2)))
(let ((.def_582 (<= .def_579 b.speed_y__AT2)))
(let ((.def_589 (not .def_582)))
(let ((.def_542 (<= 0.0 b.speed_y__AT2)))
(let ((.def_590 (or .def_542 .def_589)))
(let ((.def_580 (<= b.speed_y__AT2 .def_579)))
(let ((.def_556 (<= b.speed_y__AT2 0.0 )))
(let ((.def_557 (not .def_556)))
(let ((.def_588 (or .def_557 .def_580)))
(let ((.def_591 (and .def_588 .def_590)))
(let ((.def_115 (<= g__AT0 0.0 )))
(let ((.def_592 (or .def_115 .def_591)))
(let ((.def_584 (not .def_580)))
...
(let ((.def_521 (<= 0.0 b.y__AT2)))
(let ((.def_560 (not .def_521)))
...
(let ((.def_551 (or .def_521 .def_550)))
...
(let ((.def_537 (and .def_521 .def_536)))
...
(let ((.def_597 (and .def_54 .def_596)))
...
(let ((.def_525 (or b.counter.1__AT1 .def_199)))
(let ((.def_194 (not b.counter.2__AT1)))
(let ((.def_526 (or .def_194 .def_525)))
(let ((.def_527 (or b.counter.3__AT1 .def_526)))
(let ((.def_63 (and .def_54 .def_62)))
(let ((.def_522 (and .def_63 .def_521)))
...
(let ((.def_430 (not b.counter.3__AT2)))
...
(let ((.def_504 (or .def_406 .def_503)))
(let ((.def_505 (or b.EVENT.1__AT1 .def_504)))
(let ((.def_452 (= b.counter.0__AT2 b.counter.0__AT1)))
(let ((.def_450 (= b.counter.1__AT2 b.counter.1__AT1)))
(let ((.def_448 (= b.counter.2__AT2 b.counter.2__AT1)))
(let ((.def_447 (= b.counter.3__AT2 b.counter.3__AT1)))
(let ((.def_449 (and .def_447 .def_448)))
(let ((.def_451 (and .def_449 .def_450)))
(let ((.def_453 (and .def_451 .def_452)))
(let ((.def_500 (or .def_406 .def_453)))
(let ((.def_501 (or b.EVENT.1__AT1 .def_500)))
(let ((.def_460 (= b.x__AT1 b.x__AT2)))
(let ((.def_457 (= b.y__AT1 b.y__AT2)))
(let ((.def_494 (and .def_457 .def_460)))
(let ((.def_386 (= b.speed_x__AT1 b.speed_x__AT2)))
(let ((.def_495 (and .def_386 .def_494)))
(let ((.def_446 (= b.speed_y__AT1 b.speed_y__AT2)))
(let ((.def_496 (and .def_446 .def_495)))
(let ((.def_491 (= b.delta__AT1 0.0 )))
...
(let ((.def_471 (= b.time__AT1 b.time__AT2)))
(let ((.def_483 (and .def_460 .def_471)))
(let ((.def_484 (and .def_457 .def_483)))
(let ((.def_485 (and .def_386 .def_484)))
(let ((.def_486 (and .def_446 .def_485)))
(let ((.def_487 (and .def_453 .def_486)))
(let ((.def_488 (or .def_295 .def_487)))
(let ((.def_474 (* (- 1.0) b.time__AT2)))
(let ((.def_477 (+ b.delta__AT1 .def_474)))
(let ((.def_478 (+ b.time__AT1 .def_477)))
(let ((.def_479 (= .def_478 0.0 )))
(let ((.def_480 (or .def_406 .def_479)))
(let ((.def_481 (or b.EVENT.1__AT1 .def_480)))
(let ((.def_472 (or .def_405 .def_471)))
(let ((.def_473 (or b.EVENT.1__AT1 .def_472)))
(let ((.def_482 (and .def_473 .def_481)))
(let ((.def_489 (and .def_482 .def_488)))
(let ((.def_467 (= .def_406 b.event_is_timed__AT2)))
(let ((.def_465 (= b.event_is_timed__AT1 .def_405)))
...
(let ((.def_455 (or .def_409 .def_454)))
(let ((.def_422 (or .def_4 b.counter.0__AT1)))
(let ((.def_421 (or b.counter.0__AT2 .def_199)))
(let ((.def_423 (and .def_421 .def_422)))
(let ((.def_424 (and .def_413 .def_423)))
(let ((.def_425 (or b.counter.1__AT1 .def_424)))
(let ((.def_187 (not b.counter.1__AT1)))
(let ((.def_420 (or b.counter.1__AT2 .def_187)))
(let ((.def_426 (and .def_420 .def_425)))
(let ((.def_438 (and .def_8 .def_426)))
(let ((.def_439 (or b.counter.2__AT1 .def_438)))
(let ((.def_433 (and .def_199 .def_413)))
(let ((.def_434 (or b.counter.1__AT1 .def_433)))
(let ((.def_435 (and .def_420 .def_434)))
(let ((.def_436 (and b.counter.2__AT2 .def_435)))
(let ((.def_437 (or .def_194 .def_436)))
(let ((.def_440 (and .def_437 .def_439)))
(let ((.def_441 (and b.counter.3__AT2 .def_440)))
(let ((.def_442 (or b.counter.3__AT1 .def_441)))
(let ((.def_427 (and b.counter.2__AT2 .def_426)))
(let ((.def_428 (or b.counter.2__AT1 .def_427)))
(let ((.def_416 (or b.counter.1__AT2 b.counter.1__AT1)))
(let ((.def_414 (and b.counter.0__AT2 .def_413)))
(let ((.def_415 (or .def_187 .def_414)))
(let ((.def_417 (and .def_415 .def_416)))
(let ((.def_418 (and .def_8 .def_417)))
(let ((.def_419 (or .def_194 .def_418)))
(let ((.def_429 (and .def_419 .def_428)))
(let ((.def_431 (and .def_429 .def_430)))
(let ((.def_209 (not b.counter.3__AT1)))
(let ((.def_432 (or .def_209 .def_431)))
...
(let ((.def_444 (and .def_412 .def_443)))
(let ((.def_410 (not .def_409)))
(let ((.def_445 (or .def_410 .def_444)))
(let ((.def_456 (and .def_445 .def_455)))
(let ((.def_458 (and .def_456 .def_457)))
(let ((.def_459 (and .def_386 .def_458)))
(let ((.def_461 (and .def_459 .def_460)))
(let ((.def_462 (or .def_405 .def_461)))
...
(let ((.def_464 (and .def_407 .def_463)))
(let ((.def_469 (and .def_464 .def_468)))
(let ((.def_490 (and .def_469 .def_489)))
(let ((.def_499 (and .def_490 .def_498)))
(let ((.def_502 (and .def_499 .def_501)))
(let ((.def_506 (and .def_502 .def_505)))
(let ((.def_507 (and .def_295 .def_506)))
...
(let ((.def_529 (and .def_378 .def_528)))
(let ((.def_599 (and .def_529 .def_598)))
.def_599))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
