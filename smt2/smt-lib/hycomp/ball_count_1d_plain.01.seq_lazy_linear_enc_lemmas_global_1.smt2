...
(assert (let ((.def_271 (<= 0.0 b.speed_y__AT1)))
...
(let ((.def_302 (or .def_270 .def_271)))
(let ((.def_285 (<= .def_268 0.0 )))
(let ((.def_283 (<= b.speed_y__AT1 0.0 )))
(let ((.def_284 (not .def_283)))
(let ((.def_301 (or .def_284 .def_285)))
(let ((.def_303 (and .def_301 .def_302)))
(let ((.def_298 (and .def_283 .def_285)))
(let ((.def_297 (and .def_269 .def_271)))
...
(let ((.def_249 (and .def_60 .def_248)))
...
(let ((.def_171 (or .def_122 .def_170)))
(let ((.def_139 (or .def_6 b.counter.0__AT0)))
(let ((.def_30 (not b.counter.0__AT0)))
(let ((.def_138 (or b.counter.0__AT1 .def_30)))
(let ((.def_140 (and .def_138 .def_139)))
(let ((.def_141 (and .def_4 .def_140)))
(let ((.def_142 (or b.counter.1__AT0 .def_141)))
(let ((.def_28 (not b.counter.1__AT0)))
(let ((.def_137 (or b.counter.1__AT1 .def_28)))
(let ((.def_143 (and .def_137 .def_142)))
(let ((.def_154 (and .def_9 .def_143)))
(let ((.def_155 (or b.counter.2__AT0 .def_154)))
(let ((.def_149 (and .def_4 .def_30)))
...
(let ((.def_131 (and .def_4 b.counter.0__AT1)))
(let ((.def_132 (or .def_28 .def_131)))
(let ((.def_134 (and .def_132 .def_133)))
(let ((.def_135 (and .def_9 .def_134)))
(let ((.def_136 (or .def_33 .def_135)))
(let ((.def_146 (and .def_136 .def_145)))
(let ((.def_147 (and .def_12 .def_146)))
...
(let ((.def_161 (or .def_123 .def_160)))
...
(let ((.def_253 (and .def_120 .def_252)))
(let ((.def_306 (and .def_253 .def_305)))
.def_306))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
