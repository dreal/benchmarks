...
(assert (let ((.def_453 (* 5.0 b.delta__AT2)))
(let ((.def_454 (* b.delta__AT2 .def_453)))
(let ((.def_455 (* (- 1.0) .def_454)))
(let ((.def_451 (* b.speed_y__AT2 b.delta__AT2)))
(let ((.def_458 (+ .def_451 .def_455)))
(let ((.def_448 (* b.x__AT2 b.x__AT2)))
(let ((.def_459 (+ .def_448 .def_458)))
(let ((.def_460 (+ b.y__AT2 .def_459)))
...
(let ((.def_411 (or .def_265 .def_267)))
(let ((.def_412 (or b.EVENT.1__AT1 .def_411)))
(let ((.def_322 (= b.bool_atom__AT1 b.bool_atom__AT2)))
(let ((.def_318 (= b.counter.0__AT2 b.counter.0__AT1)))
(let ((.def_316 (= b.counter.1__AT2 b.counter.1__AT1)))
(let ((.def_314 (= b.counter.2__AT2 b.counter.2__AT1)))
(let ((.def_313 (= b.counter.3__AT2 b.counter.3__AT1)))
(let ((.def_315 (and .def_313 .def_314)))
(let ((.def_317 (and .def_315 .def_316)))
(let ((.def_319 (and .def_317 .def_318)))
(let ((.def_407 (and .def_319 .def_322)))
(let ((.def_408 (or .def_265 .def_407)))
(let ((.def_409 (or b.EVENT.1__AT1 .def_408)))
(let ((.def_203 (* (- 1.0) b.g__AT0)))
(let ((.def_396 (* .def_203 b.delta__AT1)))
...
(let ((.def_373 (and .def_305 .def_372)))
(let ((.def_374 (and .def_308 .def_373)))
(let ((.def_375 (or .def_264 .def_374)))
...
(let ((.def_325 (and .def_303 .def_324)))
...
(let ((.def_406 (and .def_326 .def_405)))
(let ((.def_410 (and .def_406 .def_409)))
(let ((.def_413 (and .def_410 .def_412)))
(let ((.def_414 (and .def_245 .def_413)))
...
(let ((.def_442 (and .def_286 .def_441)))
(let ((.def_465 (and .def_442 .def_464)))
.def_465)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
