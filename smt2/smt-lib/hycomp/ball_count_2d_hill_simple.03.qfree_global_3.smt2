...
(assert (let ((.def_631 (* 5.0 b.delta__AT3)))
...
(let ((.def_605 (not b.EVENT.0__AT3)))
(let ((.def_603 (not b.EVENT.1__AT3)))
(let ((.def_621 (and .def_603 .def_605)))
(let ((.def_622 (not .def_621)))
(let ((.def_642 (or .def_622 .def_641)))
(let ((.def_347 (not b.counter.0__AT2)))
(let ((.def_337 (not b.counter.1__AT2)))
(let ((.def_614 (and .def_337 .def_347)))
(let ((.def_617 (or b.counter.3__AT2 .def_614)))
(let ((.def_342 (not b.counter.2__AT2)))
(let ((.def_615 (and .def_342 .def_614)))
(let ((.def_356 (not b.counter.3__AT2)))
(let ((.def_616 (or .def_356 .def_615)))
(let ((.def_618 (and .def_616 .def_617)))
(let ((.def_608 (* (- 1.0) b.x__AT3)))
(let ((.def_609 (* b.x__AT3 .def_608)))
(let ((.def_610 (<= .def_609 b.y__AT3)))
...
(let ((.def_596 (or .def_4 .def_6)))
(let ((.def_600 (or b.counter.3__AT3 .def_596)))
(let ((.def_597 (or b.counter.2__AT3 .def_596)))
(let ((.def_9 (not b.counter.2__AT3)))
(let ((.def_595 (or .def_6 .def_9)))
(let ((.def_598 (and .def_595 .def_597)))
(let ((.def_12 (not b.counter.3__AT3)))
(let ((.def_599 (or .def_12 .def_598)))
...
(let ((.def_591 (or .def_445 .def_447)))
(let ((.def_592 (or b.EVENT.1__AT2 .def_591)))
(let ((.def_502 (= b.bool_atom__AT2 b.bool_atom__AT3)))
(let ((.def_498 (= b.counter.0__AT3 b.counter.0__AT2)))
(let ((.def_496 (= b.counter.1__AT3 b.counter.1__AT2)))
(let ((.def_494 (= b.counter.2__AT3 b.counter.2__AT2)))
(let ((.def_493 (= b.counter.3__AT3 b.counter.3__AT2)))
(let ((.def_495 (and .def_493 .def_494)))
(let ((.def_497 (and .def_495 .def_496)))
(let ((.def_499 (and .def_497 .def_498)))
(let ((.def_587 (and .def_499 .def_502)))
(let ((.def_588 (or .def_445 .def_587)))
(let ((.def_589 (or b.EVENT.1__AT2 .def_588)))
(let ((.def_201 (* (- 1.0) b.g__AT0)))
(let ((.def_576 (* .def_201 b.delta__AT2)))
(let ((.def_577 (* (- 1.0) b.speed_y__AT3)))
(let ((.def_580 (+ .def_577 .def_576)))
(let ((.def_581 (+ b.speed_y__AT2 .def_580)))
(let ((.def_582 (= .def_581 0.0 )))
(let ((.def_565 (* b.delta__AT2 b.delta__AT2)))
(let ((.def_204 (* (/ 1 2) .def_201)))
(let ((.def_566 (* .def_204 .def_565)))
(let ((.def_567 (* (- 1.0) b.y__AT3)))
(let ((.def_571 (+ .def_567 .def_566)))
(let ((.def_452 (* b.speed_y__AT2 b.delta__AT2)))
(let ((.def_572 (+ .def_452 .def_571)))
(let ((.def_573 (+ b.y__AT2 .def_572)))
(let ((.def_574 (= .def_573 0.0 )))
(let ((.def_485 (= b.x__AT2 b.x__AT3)))
(let ((.def_575 (and .def_485 .def_574)))
(let ((.def_583 (and .def_575 .def_582)))
(let ((.def_584 (or .def_445 .def_583)))
(let ((.def_488 (= b.y__AT2 b.y__AT3)))
(let ((.def_560 (and .def_485 .def_488)))
(let ((.def_491 (= b.speed_y__AT2 b.speed_y__AT3)))
(let ((.def_561 (and .def_491 .def_560)))
(let ((.def_557 (= b.delta__AT2 0.0 )))
(let ((.def_558 (and .def_444 .def_557)))
(let ((.def_559 (not .def_558)))
(let ((.def_562 (or .def_559 .def_561)))
(let ((.def_563 (or b.EVENT.1__AT2 .def_562)))
(let ((.def_550 (and .def_491 .def_499)))
...
(let ((.def_553 (and .def_485 .def_552)))
(let ((.def_554 (and .def_488 .def_553)))
(let ((.def_555 (or .def_444 .def_554)))
...
(let ((.def_504 (or .def_426 .def_503)))
...
(let ((.def_505 (and .def_483 .def_504)))
...
(let ((.def_586 (and .def_506 .def_585)))
(let ((.def_590 (and .def_586 .def_589)))
(let ((.def_593 (and .def_590 .def_592)))
(let ((.def_594 (and .def_426 .def_593)))
