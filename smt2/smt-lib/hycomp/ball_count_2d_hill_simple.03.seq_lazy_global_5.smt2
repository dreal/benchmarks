...
(let ((.def_884 (= b.bool_atom__AT4 b.bool_atom__AT5)))
(let ((.def_880 (= b.counter.0__AT5 b.counter.0__AT4)))
(let ((.def_878 (= b.counter.1__AT5 b.counter.1__AT4)))
(let ((.def_876 (= b.counter.2__AT5 b.counter.2__AT4)))
(let ((.def_875 (= b.counter.3__AT5 b.counter.3__AT4)))
(let ((.def_877 (and .def_875 .def_876)))
(let ((.def_879 (and .def_877 .def_878)))
(let ((.def_881 (and .def_879 .def_880)))
(let ((.def_966 (and .def_881 .def_884)))
(let ((.def_967 (or .def_849 .def_966)))
(let ((.def_968 (or b.EVENT.1__AT4 .def_967)))
(let ((.def_955 (* .def_70 b.delta__AT4)))
(let ((.def_956 (* (- 1.0) b.speed_y__AT5)))
(let ((.def_959 (+ .def_956 .def_955)))
(let ((.def_960 (+ b.speed_y__AT4 .def_959)))
(let ((.def_961 (= .def_960 0.0 )))
(let ((.def_946 (* (- 1.0) b.y__AT5)))
(let ((.def_825 (* b.speed_y__AT4 b.delta__AT4)))
(let ((.def_950 (+ .def_825 .def_946)))
(let ((.def_823 (* b.delta__AT4 b.delta__AT4)))
(let ((.def_824 (* .def_73 .def_823)))
(let ((.def_951 (+ .def_824 .def_950)))
(let ((.def_952 (+ b.y__AT4 .def_951)))
(let ((.def_953 (= .def_952 0.0 )))
(let ((.def_867 (= b.x__AT4 b.x__AT5)))
(let ((.def_954 (and .def_867 .def_953)))
(let ((.def_962 (and .def_954 .def_961)))
(let ((.def_963 (or .def_849 .def_962)))
(let ((.def_870 (= b.y__AT4 b.y__AT5)))
(let ((.def_941 (and .def_867 .def_870)))
(let ((.def_873 (= b.speed_y__AT4 b.speed_y__AT5)))
(let ((.def_942 (and .def_873 .def_941)))
(let ((.def_938 (= b.delta__AT4 0.0 )))
...
(let ((.def_931 (and .def_873 .def_881)))
(let ((.def_932 (or b.bool_atom__AT4 .def_931)))
(let ((.def_907 (or .def_6 b.counter.0__AT4)))
(let ((.def_906 (or b.counter.0__AT5 .def_726)))
(let ((.def_908 (and .def_906 .def_907)))
(let ((.def_909 (and .def_4 .def_908)))
(let ((.def_910 (or b.counter.1__AT4 .def_909)))
(let ((.def_905 (or b.counter.1__AT5 .def_716)))
(let ((.def_911 (and .def_905 .def_910)))
(let ((.def_922 (and .def_9 .def_911)))
(let ((.def_923 (or b.counter.2__AT4 .def_922)))
(let ((.def_917 (and .def_4 .def_726)))
(let ((.def_918 (or b.counter.1__AT4 .def_917)))
(let ((.def_919 (and .def_905 .def_918)))
(let ((.def_920 (and b.counter.2__AT5 .def_919)))
(let ((.def_921 (or .def_721 .def_920)))
(let ((.def_924 (and .def_921 .def_923)))
(let ((.def_925 (and b.counter.3__AT5 .def_924)))
(let ((.def_926 (or b.counter.3__AT4 .def_925)))
(let ((.def_912 (and b.counter.2__AT5 .def_911)))
(let ((.def_913 (or b.counter.2__AT4 .def_912)))
(let ((.def_901 (or b.counter.1__AT5 b.counter.1__AT4)))
(let ((.def_899 (and .def_4 b.counter.0__AT5)))
(let ((.def_900 (or .def_716 .def_899)))
(let ((.def_902 (and .def_900 .def_901)))
(let ((.def_903 (and .def_9 .def_902)))
(let ((.def_904 (or .def_721 .def_903)))
(let ((.def_914 (and .def_904 .def_913)))
(let ((.def_915 (and .def_12 .def_914)))
(let ((.def_916 (or .def_735 .def_915)))
(let ((.def_927 (and .def_916 .def_926)))
(let ((.def_896 (* b.speed_y__AT5 b.speed_y__AT5)))
(let ((.def_713 (* b.speed_y__AT4 b.speed_y__AT4)))
(let ((.def_897 (= .def_713 .def_896)))
(let ((.def_894 (+ b.speed_y__AT4 b.speed_y__AT5)))
(let ((.def_895 (= .def_894 0.0 )))
(let ((.def_898 (and .def_895 .def_897)))
(let ((.def_928 (and .def_898 .def_927)))
(let ((.def_893 (not b.bool_atom__AT4)))
(let ((.def_929 (or .def_893 .def_928)))
(let ((.def_834 (<= 0.0 b.speed_y__AT4)))
(let ((.def_890 (not .def_834)))
(let ((.def_809 (* (- 1.0) b.x__AT4)))
(let ((.def_810 (* b.x__AT4 .def_809)))
(let ((.def_889 (= b.y__AT4 .def_810)))
(let ((.def_891 (and .def_889 .def_890)))
(let ((.def_892 (= b.bool_atom__AT4 .def_891)))
(let ((.def_930 (and .def_892 .def_929)))
(let ((.def_933 (and .def_930 .def_932)))
(let ((.def_934 (and .def_867 .def_933)))
(let ((.def_935 (and .def_870 .def_934)))
(let ((.def_936 (or .def_847 .def_935)))
(let ((.def_937 (or b.EVENT.1__AT4 .def_936)))
...
(let ((.def_886 (or .def_804 .def_885)))
...
(let ((.def_1000 (and .def_846 .def_999)))
(let ((.def_1025 (and .def_1000 .def_1024)))
.def_1025))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
