...
;; generated on Mon Mar 19 10:42:40 2012
...
(let ((.def_125 (and .def_59 .def_124)))
...
(let ((.def_126 (and .def_65 .def_125)))
.def_126))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
